...
struct DesireLM : RMLifePlannerLocalModel {
    ...
    init(desireId: Int? = nil, name: String, userId: Int, dateCreated: Date, deadline: Date? = nil, dateRetired: Date? = nil, priorityLevel: Int) {
    ...
    init(desireId: Int? = nil, name: String, userId: Int, deadline: Date? = nil, dateRetired: Date? = nil, priorityLevel: Int) {
        if let desireId = desireId {
            self.desireId = desireId
        } else {
            self.desireId = try! IdsManager.generateId()
